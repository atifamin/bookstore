    ...
    <div class="col_half nobottommargin"> 
      ...
      <div class="top-links">
        <ul>
          ...
          <li><a href="faqs.html">My Account</a></li>
          <li><a href="contact.html">Wish List</a></li>
...
<header id="header" class="sticky-style-2">
  <div class="container clearfix"> 
    ...
    <ul class="header-extras">
      ...
      <?php if(!$this->Customer_model->is_logged_in(false, false)){?>
  <li> <i class="i-plain icon-signin nomargin"></i> <div class="he-text"> Make An Account<a href="<?php echo site_url("secure/login"); ?>"><span>Login/Register</span></a></div>
          <?php } ?>
          </li>
    </ul>
  </div>
      ...
      <div class="container clearfix">
        ...
        <ul>
          ...
          <li class="mega-menu"><a href="javascript:;">
            ...
            <li class="mega-menu-title"><a href="#"><div>Subjects</div></a>
            <ul>
