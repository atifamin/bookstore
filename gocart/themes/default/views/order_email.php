...
?>
		...
		<?php endforeach;?>
		<?php $AddInfo = $this->session->userdata("AdditionalInformation");  ?>
		<tr>
			<td colspan="2">PO No.#</td>
			<td colspan="4"><?php echo $AddInfo['po_number']; ?></td>
		</tr>
		<tr>
			<td colspan="2">Additional Instructions</td>
			<td colspan="4"><?php echo $AddInfo['additional_instructions']; ?></td>
		</tr>
		</tbody>
