...
<div class="row">
    <div class="coffee-span-12">
      <span class="text-element text-6"><span class="text-text-7"><a title="" href="<?php echo site_url(); ?>">HOME</a> &gt; MY ORDERS</span>
      </span>
    </div>
</div>
        ...
        <div class="subgrid subgrid-7">
          ...
          <div class="row subgrid-row-2">
            <div class="coffee-span-2 subgrid-column-19 coffee-800-span-3 coffee-414-span-12 coffee-603-span-6">
              ...
              <span class="text-element"><?php echo date('m/d/Y',strtotime($gcO->ordered_on)); ?></span>
            </div>
            <div class="coffee-span-2 subgrid-column-59 coffee-414-span-12 coffee-603-span-6">
              ...
              <span class="text-element">$<?php echo $gcO->total; ?></span>
            </div>
            <div class="coffee-span-4 subgrid-column-60 coffee-800-span-3 coffee-414-span-12 coffee-603-span-6">
              ...
              <span class="text-element"><?php if($gcO->shipped_on!='0000-00-00 00:00:00'){ echo date('m/d/Y',strtotime($gcO->shipped_on)); }else{$OrderStatus = $gcO->status; if($OrderStatus=='Approved'){echo 'Processing';}elseif($OrderStatus=='Order Completed'){echo 'Approved and Shipped';}else{echo $OrderStatus;}} ?></span>
            </div>
            <div class="coffee-span-4 subgrid-column-61 coffee-414-span-12 coffee-603-span-6">
              <span class="text-element"><span class="text-text-12">PO # <?php echo $gcO->po_number; ?></span>
              </span> 
			  <span class="text-element"><span class="text-text-12">ORDER # <?php echo $gcO->order_number; ?></span>
              </span> 
            </div>
          </div>
          <div class="row">
