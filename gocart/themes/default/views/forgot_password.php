...
<head>
  ...
  <title>Rest Password ..::.. RESPONSIVE RESPIRATORY INC.</title>
        ...
        <div class="subgrid">
          ...
          <div class="row">
            ...
            <div class="coffee-span-12">
              ...
              <h6 class="heading-1"><span class="heading-text-11">RESET PASSWORD</span>
...
<?php } ?>
		  <?php echo form_open('secure/forgot_password', 'class="my_class1"'); ?>
          ...
          <div class="row">
			...
			<button type="submit" class="link-button button-link-5 subbtn" onclick="submit_from()" role="button" name="submit">SUBMIT</button>

            </div>

          </div>
				<input type="hidden" value="submitted" name="submitted"/>
				<input type="hidden" value="<?php echo lang('reset_password');?>" name="submit"/>
		  </form>

          <div class="row">

            <div class="coffee-span-12"><a style='font-family:"Poppins",cursive;' href="<?php echo site_url('secure/login'); ?>"><?php echo lang('return_to_login');?></a></div>
