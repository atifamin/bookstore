			...
			<div class="span8">
				...
				<?php echo form_open($this->config->item('admin_folder').'/orders/index', 'class="form-inline" style="float:right"');?>
					<fieldset>
						...
						<a class="btn btn-info" target="_blank" style="float:right;margin-left:15px;" href="<?php echo site_url('admin/orders/exportorders'); ?>">EXPORT </a>
						<a class="btn btn-info" style="float:right;" href="<?php echo site_url('admin/orders'); ?>">RESET </a>
					</fieldset>
				</form>
			</div>
		</div>
...
<table class="table table-striped">
	...
	<?php if($AdminAccess=='Orders' && $order->status=='Cancelled'){ }else{ ?>	
	<tr>
