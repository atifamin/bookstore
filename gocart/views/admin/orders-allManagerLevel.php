...
<table class="table table-striped">
	...
	<tr>
		...
		<td>
			<a class="btn btn-small" style="float:right;"href="<?php echo site_url($this->config->item('admin_folder').'/orders/order/'.$order->id.'?AccessToken=kasdfji329sdfakafsdfks42');?>"><i class="icon-search"></i> <?php echo lang('form_view')?></a>
		</td>
	</tr>
    <?php endforeach; ?>
    </tbody>
