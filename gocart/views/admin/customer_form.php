<?php echo form_open($this->config->item('admin_folder').'/customers/form/'.$id); ?>
	...
	<div class="row">
		<div class="span3">
			...
			<?php
			$data	= array('name'=>'username', 'value'=>set_value('username', $username), 'class'=>'span3');
			echo form_input($data); ?>
		</div>
	</div>
...
<?php }else{ ?>
	<div class="row">
		<div class="span3">
			<label class="checkbox">
			<?php $data	= array('name'=>'email_subscribe', 'value'=>1, 'checked'=>'checked');
			echo form_checkbox($data).' '.lang('email_subscribed'); ?>
			</label>
		</div>
	</div>
...
<?php }else{ ?>
	<div class="row">
		<div class="span3">
			<label class="checkbox">
				<?php
				$data	= array('name'=>'active', 'value'=>1, 'checked'=>'checked');
				echo form_checkbox($data).' '.lang('active'); ?>
			</label>
		</div>
	</div>
