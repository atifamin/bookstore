...
<hr>
  <div class="row"> 
  <div class="span3">
  <?php echo form_open_multipart(config_item('admin_folder').'/settings/currencyRate');
  $valueUSD=$this->common_model->listingRow('symbol','USD','gc_currencies');?>
  <div clas="col-md-6">
    <label for="USD">USD</label>
    <input type="hidden" name="symbol" value="USD" />
    <input type="text" name="value" Placeholder="USD Rate"value="<?php echo $valueUSD->exchange_rate; ?>">
  </div>
  <div class="col-md-6">
    <input type="submit" class="btn btn-primary" value="<?php echo lang('save');?>">
  </div>
  ...
  <?php echo form_open_multipart(config_item('admin_folder').'/settings/currencyRate');
  $valueINR=$this->common_model->listingRow('symbol','INR','gc_currencies');?>
  <div clas="col-md-6">
    <label for="USD">INR</label>
    <input type="hidden" name="symbol" value="INR" />
    <input type="text" name="value" Placeholder="INR Rate"value="<?php echo $valueINR->exchange_rate; ?>">
  </div>
  <div class="col-md-6">
    <input type="submit" class="btn btn-primary" value="<?php echo lang('save');?>">
  </div>
  ...
  <?php echo form_open_multipart(config_item('admin_folder').'/settings/currencyRate');
  $valuePound=$this->common_model->listingRow('symbol','POUND','gc_currencies');?>
  <div clas="col-md-6">
    <label for="USD">POUND</label>
    <input type="hidden" name="symbol" value="POUND" />
    <input type="text" name="value" Placeholder="POUND Rate" value="<?php echo $valuePound->exchange_rate; ?>">
  </div>
  <div class="col-md-6">
    <input type="submit" class="btn btn-primary" value="<?php echo lang('save');?>">
  </div>
  ...
  <?php echo form_open_multipart(config_item('admin_folder').'/settings/currencyRate');
  $valueEuro=$this->common_model->listingRow('symbol','EURO','gc_currencies');?>
  <div clas="col-md-6">
    <label for="USD">EURO</label>
    <input type="hidden" name="symbol" value="EURO"  />
    <input type="text" name="value" Placeholder="EURO Rate" value="<?php echo $valueEuro->exchange_rate; ?>">
  </div>
  <div class="col-md-6">
    <input type="submit" class="btn btn-primary" value="<?php echo lang('save');?>">
  </div>
